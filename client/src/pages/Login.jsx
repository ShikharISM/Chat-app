      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {!isDatasubmitted && (
          <>
            ...
            <input onChange={(e) => setpassword(e.target.value)} type="password" required placeholder='Enter Password' className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' value={password} />
          </>
        )}
