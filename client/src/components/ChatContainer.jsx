...
const ChatContainer = () => {
    ...
    // Destructure setselectedUser to use for the back button
    const {
        getUsers,
        messages,
        users,
    ...
    // Function to handle going back to the user list on mobile
    const handleBack = () => {
    ...
    return selectedUser ? (
        <div className='h-full overflow-scroll relative backdrop-blur-lg'>
            ...
            <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
                ...
                {/* FIXED: onClick now calls handleBack to deselect the user */}
                <img onClick={handleBack} src={assets.arrow_icon} className='md:hidden max-w-7 cursor-pointer' alt="Back" />
