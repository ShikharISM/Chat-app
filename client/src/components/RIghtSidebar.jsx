...
const RightSidebar = () => {
    ...
    return selectedUser && (
        // The right sidebar is now hidden on medium and smaller screens by default
        // but will appear because of the grid layout change in Home.jsx
        <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll max-lg:hidden`}>
